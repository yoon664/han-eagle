      ...
      <section className="md:hidden absolute top-[70vh] left-0 right-0 z-40 px-4">
        <div className="flex justify-center">
          <div className="relative">
            <div className="w-[414px] h-[170px] relative overflow-hidden">
              <img
              ...
              <div className="absolute inset-0 flex top-3 left-3">
                <div className="flex-1 p-2 ml-3 text-left text-black">
                  <div className="font-bold mb-1 text-xl">{gameSchedule[0].location}</div>
                  <div className="font-medium mb-1 text-xl">{gameSchedule[0].date}</div>
                  <div className="mb-2 text-xl">{gameSchedule[0].time}</div>
                  <div className="text-orange-600 font-bold text-xl cursor-pointer hover:text-orange-700 transition-colors flex items-center space-x-1">
