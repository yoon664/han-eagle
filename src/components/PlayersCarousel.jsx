          ...
          <div className="max-w-7xl mx-auto px-4 py-16 pt-48">
            <div className="relative flex items-center justify-center">
              ...
              <div className="relative flex items-center justify-center">
                ...
                {/* 배경 넘버 */}
                <div className={`absolute left-[-250px] top-[-130px] z-0 transition-opacity duration-300 ${
                ...
                {/* 선수 정보 */}
                <div className={`absolute right-[-150px] top-24 text-white text-right transition-opacity duration-300 ${
                  isAnimating ? 'opacity-0' : 'opacity-100'
                }`}>
