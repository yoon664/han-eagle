              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <div className="mt-4 space-y-3">
                    ...
                    <a 
                      href="#history" 
                      className="block text-white text-4xl font-normal font-alumni hover:text-[#DF6D21] transition-colors"
                      onClick={() => setIsMenuOpen(false)}
                    >
                      HISTORY
                    </a>
              ...
              >
                ...
                {hoveredMenu === 'eagles' && (
                  <div className="absolute top-full left-0 pt-2">
                    ...
                    <a href="#history" className="block text-white font-semibold text-xl font-alumni hover:text-[#DF6D21] transition-colors py-2">HISTORY</a>
